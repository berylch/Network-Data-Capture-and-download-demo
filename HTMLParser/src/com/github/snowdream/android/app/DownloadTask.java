...
public class DownloadTask extends Object {
	...
	@DatabaseField
	private long size = 0;
	private boolean IsshowXiangqing = false;
	private String TextInfo = "";

	private String Textxiangqing = "";
	/**
	...
	public void setClick(boolean bIsClick) {
	...
	public DownloadTask(DownloadTask task) {
		...
		this.TextInfo = task.TextInfo;
		this.Textxiangqing = task.Textxiangqing;
		this.spead = task.spead;
	}
	...
	public boolean geShwoxiangqing() {
		return IsshowXiangqing;
	}

	public void setShwoxiangqing(boolean IsshowXiangqing) {
		this.IsshowXiangqing = IsshowXiangqing;
	}
	...
	public String getTextXiangqing() {
		return Textxiangqing;
	}

	public void setTextXiangqing(String Textxiangqing) {
		this.Textxiangqing = Textxiangqing;
	}
	...
	public boolean isComplete() {
		// return !TextUtils.isEmpty(url) && !TextUtils.isEmpty(name) &&
	...
	protected void start(Context context, DownloadListener listener,
		...
		task.executeOnExecutor(DownloadManager.getExecutor(), this);
	}
