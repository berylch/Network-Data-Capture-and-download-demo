...
import com.lxm.htmlparser.MainActivity;
import com.lxm.htmlparser.ReadUrlThread;
...
public class QuitPopAd {
		...
		if (AppConnect.getInstance(context).hasPopAd(context)) {
			...
			if (view != null) {
				...
				new AlertDialog.Builder(context)
						.setTitle("退出提示")
						.setMessage("确定要退出当前应用吗？退出后应用下载会停止，若想继续下载，请按Home退出。")
								...
								new AlertDialog.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										if (ReadUrlThread.bIsRuning) {
											MainActivity.MyThread.GetMyHandle()
													.getLooper().quit();
										}
										...
										DownloadManager downloadManager = DownloadManager
												.getInstance(context);
										List<DownloadTask> mItems = downloadManager
												.getList();
										if (mItems != null) {
	...
	private LinearLayout getQuitView_Portrait(final Context context,
		...
		textView.setText("确定要退出吗？退出后应用下载会停止，若想继续下载，请按Home退出。");
